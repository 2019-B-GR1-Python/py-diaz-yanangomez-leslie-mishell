...
class AraniaCrawOnu(CrawlSpider):
    name = 'crawl_onu'
    ...
    regla_uno = ( # busque todos los links que encuentre
    ...
    regla_dos = ( # Busque solo en el segmeto permitido del dominio permitido
        Rule(
            LinkExtractor(
    ...
    def parse_page(self, response):
        list_programas_onu = response.css('div.field-items > div.field-item > h4::text').extract()
        for agencia in list_programas_onu:
